...
--
myWorkspaces    = ["WEB","TERM","LAUNCH","GAME","DOC","TEMP","VIRT","CHAT","PASS"]

myClickableWorkspaces :: [String] myClickableWorkspaces = clickable . (map xmobarEscape)                -- $ [" 1 ", " 2 ", " 3 ", " 4 ", " 5 ", " 6 ", " 7 ", " 8 ", " 9 "]
   $ ["WEB","TERM","LAUNCH","GAME","DOC","TEMP","VIRT","CHAT","PASS"]
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((altMask .|. shiftMask, xK_Return), spawn "rofi -show run")
...
myStartupHook = do
    ...
    spawnOnce "picom &"
    spawnOnce "dunst &"
    spawnOnce "urxvtd -qof &"
    spawnOnce "lxqt-policykit-agent &"
    spawnOnce "udiskie -an &"
    spawnOnce "trayer --edge top --align right --SetDockType true --SetPartialStrut true --expand true --with 10 --transparent true --alpha 0 &"
    spawnOnce "pasystray &"
