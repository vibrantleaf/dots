...
globalkeys = gears.table.join(
    ...
    -- programs
    awful.key({ modkey, "Shift"   }, "w", function() awful.spawn("librewolf") end,
              {description = "librewolf", group = "programs"}),

    awful.key({ modkey,     }, "w", function() awful.spawn("qutebrowser") end,
              {description = "qutebrowser", group = "programs"}),
    ...
    awful.key({ modkey,    }, "n", function() awful.util.spawn(terminal.." -e newsboat") end,
              {description = "newsboat", group = "programs"}),

    awful.key({ modkey,    }, "m", function() awful.spawn(terminal.." -e ncmpcpp") end,
              {description = "ncmpcpp", group = "programs"}),

    awful.key({ modkey,    }, "e", function() awful.spawn(terminal.." -e nnn -Rd") end,
              {description = "nnn", group = "programs"}),

    awful.key({ modkey,    }, "s", function() awful.spawn("steam") end,
              {description = "steam", group = "programs"}),

    awful.key({ modkey, "Shift"    }, "s", function() awful.spawn("minigalaxy") end,
              {description = "minigalaxy", group = "programs"}),

    awful.key({ modkey, altkey}, "s", function() awful.spawn("lutris") end,
              {description = "tray", group = "programs"}),
    ...
    awful.key({ modkey,    }, "b", function() awful.spawn.with_shell("$HOME/.bin/info2") end,
              {description = "bar", group = "programs"})
    )
...
--    },
    { rule = { class = "mpv" },
      properties = { screen = 2, fullscreen = true }
    },
}
-- }}}
...
-- autostart
awful.spawn.with_shell("bash -C $HOME/.config/autorun/autorun.sh")
