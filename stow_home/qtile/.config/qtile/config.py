...
colors = [["#2E3440", "#2E3440"], # panel background
          ...
          ["#B48EAD", "#B48EAD"], # border line color for current tab
          ["#81A1C1", "#81A1C1"], # border line color for 'other tabs' and color for 'odd widgets'
          ["#B38EAD", "#B38EAD"], # color for the 'even widgets'
          ["#D8DEE9", "#D8DEE9"], # window name
          ["#D08770", "#D08770"]] # backbround for inactive screens
